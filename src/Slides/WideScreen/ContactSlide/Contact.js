...
class Contact extends Component {
  ...
  handleScroll(event) {
    ...
    const minlimit = (documentElement.clientHeight * 930) / documentElement.scrollHeight;
  ...
  render() {
    ...
    return (
      <Container>
        ...
        <SocialMediaIcons>
          <SocialLogo imgURL={twitterImg} alternate="Twitter" redirectURL="https://twitter.com/screammy" />
          <SocialLogo imgURL={githubImg} alternate="Github" redirectURL="https://github.com/pashchenkoruslan" />
          <SocialLogo imgURL={mailImg} alternate="Mail" redirectURL="mailto:RuslanPYou@gmail.com" />
          <SocialLogo imgURL={instaImg} alternate="Instagram" redirectURL="https://www.instagram.com/scre4mmy/" />
          <SocialLogo imgURL={dribbbleImg} alternate="Dribbble" redirectURL="https://dribbble.com/#" />
          <SocialLogo imgURL={linkedInImg} alternate="Linkedin" redirectURL="https://www.linkedin.com/in/#" />
        </SocialMediaIcons>
      </Container>
    );
  }
